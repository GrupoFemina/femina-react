const data = {
  ...
  cards: [
    ...
    /* --- SETOR: ADMINISTRATIVO --- */
    {
      ...
      desc: "Foto do documento (RG/CNH) frente e verso,\n\nSelfie com o documento junto.\n\nComprovante de endereço atualizado e em seu nome, (caso não tenha, enviar foto do documento do titular junto com o comprovante).\n\nCarta a próprio punho informando que está residindo no endereço atual.\n\n<strong>ENVIAR A DOCUMENTAÇÃO PARA O E-MAIL:</strong><br><strong>\nSe você for de Joinville:</strong> admjoinville@grupofemina.com.br<br><strong>\nSe for de Florianópolis:</strong> admflorianopolis@grupofemina.com.br<br><strong>\nOu se for de Rio do Sul:</strong> admriodosul@grupofemina.com.br",
    ...
    },
    {
      ...
      desc: "<strong>ESPAÇO DO REVENDEDOR - RIO DO SUL/SC</strong><br>Rodovia BR-470...<br>📞 (47) 3525-3932<br><br><strong>ESPAÇO DO REVENDEDOR - ESTREITO/SC</strong><br>Rua Santiago Dantas...<br>📞 (48) 3039-0976",
      idList: "683615767be3d4dd7675250d"
    },
    {
      name: "CÓDIGOS ESTOQUES",
      desc: "<table style='border-collapse: collapse; width: 100%;'><thead><tr style='background-color: #f2f2f2;'><th style='border: 1px solid #ddd; padding: 8px;'>CÓDIGO - EMPRESA</th><th style='border: 1px solid #ddd; padding: 8px;'>LOCAL</th></tr></thead><tbody><tr><td style='border: 1px solid #ddd; padding: 8px;'>23431 - SAGUAÇU</td><td style='border: 1px solid #ddd; padding: 8px;'>JOINVILLE</td></tr></tbody></table>",
      idList: "683615767be3d4dd7675250d"
    }
  ]
};
